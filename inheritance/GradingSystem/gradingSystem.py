...
Now calculate the average of the numbers (1,5,18,-3) and assign to a variable named 'avg'."""
...
grader.start_assignment("Manish",itp_id)
print("Manish's lesson:" , grader.get_lesson("Manish"))
print("Manish's check:" , grader.check_assignment("Manish","a = 1 ; b = 'hello'"))
print("Manish's other check:" , grader.check_assignment("Manish","a = 1\nb = 'hello'"))
print(grader.assignment_summary("Manish"))

grader.start_assignment("Manish",stat_id)
print("Manish's lesson:" , grader.get_lesson("Manish"))
print("Manish's check:" ,  grader.check_assignment("Manish", "avg=5.25"))
print("Manish's other check:" ,  grader.check_assignment("Manish","avg = statistics.mean([1, 5, 18, -3])"))
# print(grader.assignment_summary("Manish"))
    
# print(issubclass(AssignmentGrader,Assignment))